...
static struct rpmsg_driver  msic_battery_rpmsg_driver = {
...
{
	return register_rpmsg_driver(&msic_battery_rpmsg_driver);
}
...
{
	return unregister_rpmsg_driver(&msic_battery_rpmsg_driver);
}
