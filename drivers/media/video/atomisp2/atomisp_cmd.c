...
void atomisp_set_term_en_count(struct atomisp_device *isp)
{
	...
	#if 1 /* The value recommended by Intel(0x1B ~ 0x2D) -  MIPI Clock: 384Mbps */
	...
	#if 1 /* The value recommended by Intel(0x19 ~ 0x2A) -  MIPI Clock: 696Mbps */
	val |= 0x21 << (pwn_b0 ? TERM_EN_COUNT_4LANE_PWN_B0_OFFSET :
