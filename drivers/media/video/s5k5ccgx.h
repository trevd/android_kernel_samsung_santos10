...
enum s5k5ccgx_capture_frame_size {
	...
	S5K5CCGX_CAPTURE_0_7MP, 		/* 960x720 */
	S5K5CCGX_CAPTURE_W0_9MP, 		/* 1280x720 */
	S5K5CCGX_CAPTURE_1_3MP,			/* 1280x960 */
	S5K5CCGX_CAPTURE_W1_3MP,			/* 1536x864 */
	S5K5CCGX_CAPTURE_2MP,			/* 1600x1200 */
	S5K5CCGX_CAPTURE_W2MP,		/* 35mm Academy Offset Standard 1.66 */
					/* 2048x1232, 2.4MP */
	S5K5CCGX_CAPTURE_3MP,		/* QXGA  - 2048x1536 */
...
struct s5k5ccgx_regs {
	struct s5k5ccgx_regset_table ev[EV_MAX_V4L2];
	struct s5k5ccgx_regset_table metering[V4L2_EXPOSURE_METERING_SPOT + 1];
	struct s5k5ccgx_regset_table iso[ISO_MAX];
	struct s5k5ccgx_regset_table effect[V4L2_COLORFX_SET_CBCR + 1];
	struct s5k5ccgx_regset_table white_balance[V4L2_WHITE_BALANCE_SHADE + 1];
	...
	struct s5k5ccgx_regset_table scene_mode[V4L2_SCENE_MODE_TEXT + 1];
	...
	struct s5k5ccgx_regset_table antibanding[V4L2_CID_POWER_LINE_FREQUENCY_AUTO+1];
};
...
struct s5k5ccgx_state {
	...
	enum v4l2_scene_mode post_scene_mode;
	...
	u32 initialized:1;
	u32 preview_set:1; /* preview start */
	u32 need_set_scene:1; /* need set scene mode */
};
...
#define SENSOR_JPEG_SNAPSHOT_MEMSIZE \
	(((SENSOR_JPEG_OUTPUT_MAXSIZE + EXTRA_MEMSIZE  + SZ_16K-1) / SZ_16K) \
	* SZ_16K)
#endif
...
#define SCENE_NIGHT_CAPTURE_DELAY 520
#define SCENE_NIGHT_PREVIEW_DELAY 230
#define S5K5CCGX_STREAM_OFF_DELAY 150
...
#define TUNING_FILE_PATH "/mnt/sdcard/s5k5ccgx_regs.h"
#endif /* CONFIG_LOAD_FILE*/
