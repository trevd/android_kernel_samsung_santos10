...
#ifdef CONFIG_UMTS_MODEM_XMM626X
DECLARE_MODEM_INIT(xmm6262);
#else
DECLARE_MODEM_INIT_DUMMY(xmm6262)
#endif

#ifdef CONFIG_LTE_MODEM_XMM7160
DECLARE_MODEM_INIT(xmm7160);
#else
DECLARE_MODEM_INIT_DUMMY(xmm7160)
#endif
...
#ifdef CONFIG_LINK_DEVICE_MIPI_EDLP
DECLARE_LINK_INIT(mipi_edlp);
#else
DECLARE_LINK_INIT_DUMMY(mipi_edlp)
#endif
