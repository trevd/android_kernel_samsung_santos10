/* arch/x86/platform/intel-mid/sec_libs/sec_getlog.c
 *
...
static void __init sec_getlog_supply_loggerinfo(void *p_main,
...
static void __init sec_getlog_init_kloginfo(void)
{
	...
	sec_getlog_supply_kloginfo((void *)
			(unsigned long)virt_to_phys(klog_buf));
}
