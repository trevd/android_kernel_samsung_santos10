...
static struct cmc624_register_set cmc624_init[] = {
	/* CLOCK_TOP */
	{0x00, 0x0002}, /* BANK 2 */
	...
	{0x3B, 0x040B}, /* CLOCK DIVIDER VALUE (M1 = 4, M2 = 11) */
	...
	{0x67, 0x000A}, /* VSYNC PULSE WIDTH = 10 */
	{0x68, 0x000F}, /* HSYNC PULSE WIDTH = 15 */
	{0x69, 0x000E}, /* VBP = 14 */
	{0x6A, 0x000E}, /* VFP = 14 */
	{0x6B, 0x0049}, /* HBP = 73 */
	{0x6C, 0x0050}, /* HFP = 80 */
	...
	{0xF9, 0x0000}, /* DEFAULT OFF */

	/* CONV */
	{0x00, 0x0003}, /* BANK 3 */
	{0x01, 0x0000}, /* I2C TO MIPI */
	{0x43, 0x7000}, /* M_BAND_CTL */
	{0x42, 0x22D9}, /* M_PLL SETTING (Fout = 436.80MHz) */
	...
	{0x94, 0x000C}, /* HORIZANTAL SYNC PADDING COUNT */
	{0x96, 0x0037}, /* HORIZANTAL BACK PORCH COUNT */
	{0x98, 0x003C}, /* HORIZANTAL FRONT FORCH COUNT */
	{0x9A, 0x03C0}, /* HORIZANTAL ACTIVE AREA */

	{0x9C, 0x000A}, /* VERTICAL SYNC PADDING COUNT */
	{0x9E, 0x000E}, /* VERTICAL BACK PORCH COUNT */
	{0xA0, 0x000E}, /* VERTICAL FRONT FORCH COUNT */
	...
	{0xB4, 0x0003}, /* LP EQUIVALENT BYTECLK */
	...
	{0xD4, 0x000F}, /* HSYNC COUNT = 15 */
	{0xD5, 0x000A}, /* VSYNC COUNT = 10 */
...
static struct cmc624_register_set tune_auto_browser_cabcoff[] = {
	...
	{0x00c0, 0x1212}, /* CS hg ry */
	{0x00c1, 0x1010}, /* CS hg gc */
	{0x00c2, 0x1414}, /* CS hg bm */
...
static struct cmc624_register_set tune_auto_browser_cabcon[] = {
	{0x0000, 0x0000}, /* BANK 0 */
...
static struct cmc624_register_set tune_auto_gallery_cabcoff[] = {
	{0x0000, 0x0000}, /* BANK 0 */
...
static struct cmc624_register_set tune_auto_gallery_cabcon[] = {
	{0x0000, 0x0000}, /* BANK 0 */
...
static struct cmc624_register_set tune_auto_ui_cabcoff[] = {
	{0x0000, 0x0000}, /* BANK 0 */
	{0x0008, 0x0220}, /* SCR2 CC1 | CS2 DE1 | LoG8 WIENER4 NR2 HDR1 */
	{0x0009, 0x0000}, /* MCM off */
	{0x000a, 0x0000}, /* UC off */
...
static struct cmc624_register_set tune_auto_ui_cabcon[] = {
	{0x0000, 0x0000}, /* BANK 0 */
	{0x0008, 0x0a20}, /* ABC8 CP4 SCR2 CC1 | CS2 DE1 | LoG8 WIENER4 NR2 HDR1 */
	{0x0009, 0x0000}, /* MCM off */
	{0x000a, 0x0000}, /* UC off */
...
/* yet ... */
static struct cmc624_register_set tune_auto_video_cabcoff[] = {
	{0x0000, 0x0000}, /* BANK 0 */
	{0x0008, 0x0230}, /* SCR2 CC1 | CS2 DE1 | LoG8 WIENER4 NR2 HDR1 */
	{0x0009, 0x0000}, /* MCM off */
	{0x000a, 0x0000}, /* UC off */
...
static struct cmc624_register_set tune_auto_video_cabcon[] = {
	{0x0000, 0x0000}, /* BANK 0 */
	{0x0008, 0x0a30}, /* ABC8 CP4 SCR2 CC1 | CS2 DE1 | LoG8 WIENER4 NR2 HDR1 */
	{0x0009, 0x0000}, /* MCM off */
	{0x000a, 0x0000}, /* UC off */
...
static struct cmc624_register_set tune_auto_vtcall_cabcoff[] = {
	{0x0000, 0x0000}, /* BANK 0 */
...
static struct cmc624_register_set tune_auto_vtcall_cabcon[] = {
	{0x0000, 0x0000}, /* BANK 0 */
...
static struct cmc624_register_set tune_bypass[] = {
	{0x0000, 0x0000}, /* BANK 0 */
...
static struct cmc624_register_set tune_camera[] = {
	{0x0000, 0x0000}, /* BANK 0 */
	{0x0008, 0x0230}, /* SCR2 CC1 | CS2 DE1 | LoG8 WIENER4 NR2 HDR1 */
	{0x0009, 0x0000}, /* MCM off */
	{0x000a, 0x0000}, /* UC off */
...
static struct cmc624_register_set tune_dynamic_browser_cabcoff[] = {
	{0x0000, 0x0000}, /* BANK 0 */
...
static struct cmc624_register_set tune_dynamic_browser_cabcon[] = {
	{0x0000, 0x0000}, /* BANK 0 */
...
static struct cmc624_register_set tune_dynamic_gallery_cabcoff[] = {
	{0x0000, 0x0000}, /* BANK 0 */
...
static struct cmc624_register_set tune_dynamic_gallery_cabcon[] = {
	{0x0000, 0x0000}, /* BANK 0 */
...
static struct cmc624_register_set tune_dynamic_ui_cabcoff[] = {
	{0x0000, 0x0000}, /* BANK 0 */
	{0x0008, 0x0320}, /* SCR2 CC1 | CS2 DE1 | LoG8 WIENER4 NR2 HDR1 */
	{0x0009, 0x0000}, /* MCM off */
	{0x000a, 0x0000}, /* UC off */
...
static struct cmc624_register_set tune_dynamic_ui_cabcon[] = {
	{0x0000, 0x0000}, /* BANK 0 */
	{0x0008, 0x0b20}, /* ABC8 CP4 SCR2 CC1 | CS2 DE1 | LoG8 WIENER4 NR2 HDR1 */
	{0x0009, 0x0000}, /* MCM off */
	{0x000a, 0x0000}, /* UC off */
...
static struct cmc624_register_set tune_dynamic_video_cabcoff[] = {
	{0x0000, 0x0000}, /* BANK 0 */
	{0x0008, 0x0330}, /* SCR2 CC1 | CS2 DE1 | LoG8 WIENER4 NR2 HDR1 */
	{0x0009, 0x0000}, /* MCM off */
	{0x000a, 0x0000}, /* UC off */
...
static struct cmc624_register_set tune_dynamic_video_cabcon[] = {
	{0x0000, 0x0000}, /* BANK 0 */
	{0x0008, 0x0b30}, /* ABC8 CP4 SCR2 CC1 | CS2 DE1 | LoG8 WIENER4 NR2 HDR1 */
	{0x0009, 0x0000}, /* MCM off */
	{0x000a, 0x0000}, /* UC off */
...
static struct cmc624_register_set tune_dynamic_vtcall_cabcoff[] = {
	{0x0000, 0x0000}, /* BANK 0 */
...
static struct cmc624_register_set tune_dynamic_vtcall_cabcon[] = {
	{0x0000, 0x0000}, /* BANK 0 */
...
static struct cmc624_register_set tune_ebook_cabcoff[] = {
	{0x0000, 0x0000}, /* BANK 0 */
...
static struct cmc624_register_set tune_ebook_cabcon[] = {
	{0x0000, 0x0000}, /* BANK 0 */
...
static struct cmc624_register_set tune_movie_browser_cabcoff[] = {
	{0x0000, 0x0000}, /* BANK 0 */
	{0x0008, 0x0200}, /* SCR2 CC1 | CS2 DE1 | LoG8 WIENER4 NR2 HDR1 */
	{0x0009, 0x0000}, /* MCM off */
	{0x000a, 0x0000}, /* UC off */
...
static struct cmc624_register_set tune_movie_browser_cabcon[] = {
	{0x0000, 0x0000}, /* BANK 0 */
	{0x0008, 0x0a00}, /* ABC8 CP4 SCR2 CC1 | CS2 DE1 | LoG8 WIENER4 NR2 HDR1 */
	{0x0009, 0x0000}, /* MCM off */
	{0x000a, 0x0000}, /* UC off */
...
static struct cmc624_register_set tune_movie_gallery_cabcoff[] = {
	{0x0000, 0x0000}, /* BANK 0 */
	{0x0008, 0x0200}, /* SCR2 CC1 | CS2 DE1 | LoG8 WIENER4 NR2 HDR1 */
	{0x0009, 0x0000}, /* MCM off */
	{0x000a, 0x0000}, /* UC off */
...
static struct cmc624_register_set tune_movie_gallery_cabcon[] = {
	{0x0000, 0x0000}, /* BANK 0 */
	{0x0008, 0x0a00}, /* ABC8 CP4 SCR2 CC1 | CS2 DE1 | LoG8 WIENER4 NR2 HDR1 */
	{0x0009, 0x0000}, /* MCM off */
	{0x000a, 0x0000}, /* UC off */
...
static struct cmc624_register_set tune_movie_ui_cabcoff[] = {
	{0x0000, 0x0000}, /* BANK 0 */
	{0x0008, 0x0200}, /* SCR2 CC1 | CS2 DE1 | LoG8 WIENER4 NR2 HDR1 */
	{0x0009, 0x0000}, /* MCM off */
	{0x000a, 0x0000}, /* UC off */
...
static struct cmc624_register_set tune_movie_ui_cabcon[] = {
	{0x0000, 0x0000}, /* BANK 0 */
	{0x0008, 0x0a00}, /* ABC8 CP4 SCR2 CC1 | CS2 DE1 | LoG8 WIENER4 NR2 HDR1 */
	{0x0009, 0x0000}, /* MCM off */
	{0x000a, 0x0000}, /* UC off */
...
static struct cmc624_register_set tune_movie_video_cabcoff[] = {
	{0x0000, 0x0000}, /* BANK 0 */
	{0x0008, 0x0200}, /* SCR2 CC1 | CS2 DE1 | LoG8 WIENER4 NR2 HDR1 */
	{0x0009, 0x0000}, /* MCM off */
	{0x000a, 0x0000}, /* UC off */
...
static struct cmc624_register_set tune_movie_video_cabcon[] = {
	{0x0000, 0x0000}, /* BANK 0 */
	{0x0008, 0x0a00}, /* ABC8 CP4 SCR2 CC1 | CS2 DE1 | LoG8 WIENER4 NR2 HDR1 */
	{0x0009, 0x0000}, /* MCM off */
	{0x000a, 0x0000}, /* UC off */
...
static struct cmc624_register_set tune_movie_vtcall_cabcoff[] = {
	{0x0000, 0x0000}, /* BANK 0 */
	{0x0008, 0x0232}, /* SCR2 CC1 | CS2 DE1 | LoG8 WIENER4 NR2 HDR1 */
	{0x0009, 0x0000}, /* MCM off */
	{0x000a, 0x0000}, /* UC off */
...
static struct cmc624_register_set tune_movie_vtcall_cabcon[] = {
	{0x0000, 0x0000}, /* BANK 0 */
	{0x0008, 0x0a32}, /* ABC8 CP4 SCR2 CC1 | CS2 DE1 | LoG8 WIENER4 NR2 HDR1 */
	{0x0009, 0x0000}, /* MCM off */
	{0x000a, 0x0000}, /* UC off */
...
static struct cmc624_register_set tune_negative_cabcoff[] = {
	{0x0000, 0x0000}, /* BANK 0 */
	{0x0008, 0x0200}, /* SCR2 CC1 | CS2 DE1 | LoG8 WIENER4 NR2 HDR1 */
	{0x0009, 0x0000}, /* MCM off */
	{0x000a, 0x0000}, /* UC off */
...
static struct cmc624_register_set tune_negative_cabcon[] = {
	{0x0000, 0x0000}, /* BANK 0 */
	{0x0008, 0x0a00}, /* ABC8 CP4 SCR2 CC1 | CS2 DE1 | LoG8 WIENER4 NR2 HDR1 */
	{0x0009, 0x0000}, /* MCM off */
	{0x000a, 0x0000}, /* UC off */
...
/*start CMC624 LCD Color Adjustment cabcoff*/
static struct cmc624_register_set tune_color_blind_cabcoff[] = {
	{0x0000, 0x0000}, /*BANK 0*/
...
/*start CMC624 LCD Color Adjustment cabcon*/
static struct cmc624_register_set tune_color_blind_cabcon[] = {
	{0x0000, 0x0000}, /*BANK 0*/
...
static struct cmc624_register_set tune_standard_browser_cabcoff[] = {
	{0x0000, 0x0000}, /* BANK 0 */
	{0x0008, 0x0220}, /* SCR2 CC1 | CS2 DE1 | LoG8 WIENER4 NR2 HDR1 */
	{0x0009, 0x0000}, /* MCM off */
	{0x000a, 0x0000}, /* UC off */
...
static struct cmc624_register_set tune_standard_browser_cabcon[] = {
	{0x0000, 0x0000}, /* BANK 0 */
	{0x0008, 0x0a20}, /* ABC8 CP4 SCR2 CC1 | CS2 DE1 | LoG8 WIENER4 NR2 HDR1 */
	{0x0009, 0x0000}, /* MCM off */
	{0x000a, 0x0000}, /* UC off */
...
static struct cmc624_register_set tune_standard_gallery_cabcoff[] = {
	{0x0000, 0x0000}, /* BANK 0 */
	{0x0008, 0x0230}, /* SCR2 CC1 | CS2 DE1 | LoG8 WIENER4 NR2 HDR1 */
	{0x0009, 0x0000}, /* MCM off */
	{0x000a, 0x0000}, /* UC off */
...
static struct cmc624_register_set tune_standard_gallery_cabcon[] = {
	{0x0000, 0x0000}, /* BANK 0 */
	{0x0008, 0x0a30}, /* ABC8 CP4 SCR2 CC1 | CS2 DE1 | LoG8 WIENER4 NR2 HDR1 */
	{0x0009, 0x0000}, /* MCM off */
	{0x000a, 0x0000}, /* UC off */
...
static struct cmc624_register_set tune_standard_ui_cabcoff[] = {
	{0x0000, 0x0000}, /* BANK 0 */
	{0x0008, 0x0220}, /* SCR2 CC1 | CS2 DE1 | LoG8 WIENER4 NR2 HDR1 */
	{0x0009, 0x0000}, /* MCM off */
	{0x000a, 0x0000}, /* UC off */
...
static struct cmc624_register_set tune_standard_ui_cabcon[] = {
	{0x0000, 0x0000}, /* BANK 0 */
	{0x0008, 0x0a20}, /* ABC8 CP4 SCR2 CC1 | CS2 DE1 | LoG8 WIENER4 NR2 HDR1 */
	{0x0009, 0x0000}, /* MCM off */
	{0x000a, 0x0000}, /* UC off */
...
static struct cmc624_register_set tune_standard_video_cabcoff[] = {
	{0x0000, 0x0000}, /* BANK 0 */
	{0x0008, 0x0230}, /* SCR2 CC1 | CS2 DE1 | LoG8 WIENER4 NR2 HDR1 */
	{0x0009, 0x0000}, /* MCM off */
	{0x000a, 0x0000}, /* UC off */
...
static struct cmc624_register_set tune_standard_video_cabcon[] = {
	{0x0000, 0x0000}, /* BANK 0 */
	{0x0008, 0x0a30}, /* ABC8 CP4 SCR2 CC1 | CS2 DE1 | LoG8 WIENER4 NR2 HDR1 */
	{0x0009, 0x0000}, /* MCM off */
	{0x000a, 0x0000}, /* UC off */
...
static struct cmc624_register_set tune_standard_vtcall_cabcoff[] = {
	{0x0000, 0x0000}, /* BANK 0 */
	{0x0008, 0x0232}, /* SCR2 CC1 | CS2 DE1 | LoG8 WIENER4 NR2 HDR1 */
	{0x0009, 0x0000}, /* MCM off */
	{0x000a, 0x0000}, /* UC off */
...
static struct cmc624_register_set tune_standard_vtcall_cabcon[] = {
	{0x0000, 0x0000}, /* BANK 0 */
	{0x0008, 0x0a32}, /* ABC8 CP4 SCR2 CC1 | CS2 DE1 | LoG8 WIENER4 NR2 HDR1 */
	{0x0009, 0x0000}, /* MCM off */
	{0x000a, 0x0000}, /* UC off */
